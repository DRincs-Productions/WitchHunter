...
translate italian strings:
    ...
    new "Consegnare i test della prossima lezione"
    ...
    new "Ottenere un microfono per il club di giornalismo"
    ...
    new "Chiedete a Miranda dove trovare la narice di drago."

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Добыть клык Ларвека Миранде в обмен на Ноздрю дракона"
    new "Ottenere una zanna Larvek per Miranda in cambio della narice di drago."
