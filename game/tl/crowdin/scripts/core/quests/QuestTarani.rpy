...
translate crowdin strings:
    ...
    new "Провести первый урок"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Провести урок и проверить контрольную работу занизив оценку Тарани"
    new "Провести урок и проверить контрольную работу занизив оценку Тарани"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Раздать контрольные работы на следующем уроке"
    new "Раздать контрольные работы на следующем уроке"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Занизить оценку домашней работы Тарани"
    new "Занизить оценку домашней работы Тарани"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Поговорить с Тарани после урока"
    new "Поговорить с Тарани после урока"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Провести очередной урок"
    new "Провести очередной урок"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Распросить о Тарани в школьном клубе журналистике"
    new "Распросить о Тарани в школьном клубе журналистике"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Достать микрофон для клуба журналистики"
    new "Достать микрофон для клуба журналистики"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Отнести микрофон Бэсс и Кортни и разузнать о Тарани"
    new "Отнести микрофон Бэсс и Кортни и разузнать о Тарани"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Попросить Бланка сделать фотографии Найджела"
    new "Попросить Бланка сделать фотографии Найджела"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Достать фотоаппарат для Бланка"
    new "Достать фотоаппарат для Бланка"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Узнать у миранды где достать Ноздрю дракона"
    new "Узнать у миранды где достать Ноздрю дракона"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Добыть клык Ларвека Миранде в обмен на Ноздрю дракона"
    new "Добыть клык Ларвека Миранде в обмен на Ноздрю дракона"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Отдать Бланку Ноздрю дракона и фотоаппарат"
    new "Отдать Бланку Ноздрю дракона и фотоаппарат"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Дождаться когда Бланк сделает фотографии Найджела и забрать их"
    new "Дождаться когда Бланк сделает фотографии Найджела и забрать их"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Шантажировать Тарани фотографиями Найджела"
    new "Шантажировать Тарани фотографиями Найджела"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Попросить Тарани сделать нам приятное после урока"
    new "Попросить Тарани сделать нам приятное после урока"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Попросить Тарани поработать ртом"
    new "Попросить Тарани поработать ртом"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Навестить Тарани у нее дома"
    new "Навестить Тарани у нее дома"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Попросить Бланка сделать новые фотографии Найджела"
    new "Попросить Бланка сделать новые фотографии Найджела"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Добыть Бланку золотую цепочку либо найти ему девушку для секса"
    new "Добыть Бланку золотую цепочку либо найти ему девушку для секса"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Навестить Тарани у нее дома вечером и показать ей фотографии Найджела"
    new "Навестить Тарани у нее дома вечером и показать ей фотографии Найджела"

    # game/scripts/core/quests/QuestTarani.rpy:41
    old "Поговорить с Тарани в школе"
    new "Поговорить с Тарани в школе"
